...
/**
 * Île client du Journal d'activité. Reçoit les activités déjà récupérées côté
 * serveur (`initialActivities`) → plus de fetch on-mount ni d'état de
 * chargement client. Toute l'interactivité (recherche + filtres) reste ici.
 */
