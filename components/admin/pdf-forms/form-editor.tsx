    ...
    <div className="p-6">
      ...
      <div className="sticky top-0 z-10 -mx-6 mb-4 flex flex-wrap items-center gap-2 border-b bg-background/95 px-6 py-3 backdrop-blur">
        ...
        {form.status === "published" ? (
          ...
          return (
            <Tooltip>
              {/* Un <button disabled> ne déclenche pas les events souris,
                  donc le tooltip ne s'afficherait pas. On enveloppe d'un span
                  focusable pour exposer l'explication même bouton désactivé. */}
      ...
      <div className="flex flex-col gap-4">
        {/* Contrôles de publication : on affiche toujours un état pour que
            l'utilisateur sache pourquoi il peut (ou non) publier. */}
        <Card>
          ...
          return (
            <Tabs defaultValue="schema" className="w-full">
              ...
              <TabsContent value="visual">
                <VisualEditor
                  formId={formId}
                  onMaterialized={() => { load(); loadIssues(); }}
                />
              </TabsContent>
            </Tabs>
          );
