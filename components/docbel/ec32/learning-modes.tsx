...
import { Compass, LayoutList, type LucideProps, Sparkles } from 'lucide-react'
...
export function Ec32LearningModes({ content }: { content: Ec32Content }) {
    ...
    >
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {learningModes.modes.map((mode, index) => {
          ...
          return (
            <Ec32Card key={mode.key || index} className="flex flex-col gap-3">
