...
export function PdfField({
  ...
  if (field.type === "checkbox") {
    ...
    if (rowLayout) {
      // Case TOUJOURS en début de ligne, avant le libellé (Oraliks 2026-07-18 :
      // « les coches à gauche partout »). Top-alignée (`items-start`) car un
      // libellé long (affirmations, annexes) peut passer sur plusieurs lignes.
      return (
