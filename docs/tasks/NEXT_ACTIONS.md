...
| 22 | P3 | RioLex | Peupler les mappings article↔code Lookup (encart « Codes ONEM liés »). **1er article fait : art. 153 → sanctions 153,1/153,2/153,3.** Reste : suite série sanctions (154/155/157/158/159) + autres tables — **domaine Oraliks, ne pas inventer** | `lib/data/riolex-lookup-refs.json` | Faible | `pnpm attach:lookup-refs --dry` + fiche article | en cours |
