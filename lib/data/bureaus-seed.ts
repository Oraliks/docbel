...
export const COMMUNES_BRUSSELS: BureauSeed[] = [
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Hôtel de Ville de Bruxelles", street: "Grand-Place", postalCode: "1000", city: "Bruxelles", insCode: "21004", phone: "02 279 22 11", website: "https://www.bruxelles.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
...
export const CPAS_GRANDES_VILLES: BureauSeed[] = [
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Hôtel de Ville de Liège", street: "Place du Marché", streetNum: "2", postalCode: "4000", city: "Liège", insCode: "62063", phone: "04 221 81 11", website: "https://www.liege.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
  // Charleroi
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Hôtel de Ville de Charleroi", street: "Place Charles II", streetNum: "14", postalCode: "6000", city: "Charleroi", insCode: "52011", phone: "071 86 11 11", website: "https://www.charleroi.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
  // Mons
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Hôtel de Ville de Mons", street: "Grand-Place", streetNum: "22", postalCode: "7000", city: "Mons", insCode: "53053", phone: "065 40 51 11", website: "https://www.mons.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
  // Namur
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Hôtel de Ville de Namur", street: "Esplanade de l'Hôtel de Ville", streetNum: "1", postalCode: "5000", city: "Namur", insCode: "92094", phone: "081 24 60 11", website: "https://www.namur.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
  // Antwerpen
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Stadhuis Antwerpen", nameNl: "Stadhuis Antwerpen", street: "Grote Markt", streetNum: "1", postalCode: "2000", city: "Antwerpen", insCode: "11002", phone: "03 22 11 333", website: "https://www.antwerpen.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
  // Gent
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Stadhuis Gent", nameNl: "Stadhuis Gent", street: "Botermarkt", streetNum: "1", postalCode: "9000", city: "Gent", insCode: "44021", phone: "09 266 50 50", website: "https://www.gent.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
  // Brugge
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Stadhuis Brugge", nameNl: "Stadhuis Brugge", street: "Burg", streetNum: "12", postalCode: "8000", city: "Brugge", insCode: "31005", phone: "050 44 81 11", website: "https://www.brugge.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
  // Leuven
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Stadhuis Leuven", nameNl: "Stadhuis Leuven", street: "Grote Markt", streetNum: "9", postalCode: "3000", city: "Leuven", insCode: "24062", phone: "016 27 20 00", website: "https://www.leuven.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
  // Hasselt
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Stadhuis Hasselt", nameNl: "Stadhuis Hasselt", street: "Limburgplein", streetNum: "1", postalCode: "3500", city: "Hasselt", insCode: "71022", phone: "011 23 90 90", website: "https://www.hasselt.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
  // Eupen (germanophone)
  ...
  { organismeCode: "commune", type: "COMMUNE", name: "Rathaus Eupen", nameDe: "Rathaus Eupen", street: "Rathausplatz", streetNum: "14", postalCode: "4700", city: "Eupen", insCode: "62022", phone: "087 55 96 96", website: "https://www.eupen.be", hours: STD_ADMIN, services: ["etat_civil", "population", "urbanisme"] },
];
