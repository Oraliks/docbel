...
export const changementSituationPersonnelle: DossierDefinition = {
  ...
  description:
    "Déclarez un changement d'adresse, de compte bancaire, de situation familiale, de permis de séjour, de cotisation syndicale ou d'organisme de paiement pendant que vous touchez des allocations.",
  ...
  warnings: [
    {
      ...
      message:
        "Si vos changements n'ont pas tous la même date d'effet, faites une déclaration séparée pour chaque date différente.",
  ...
  journey: [
    ...
    },
    {
      ...
      body: "Vous pouvez cocher plusieurs cases à la fois si elles prennent effet à la même date. Sinon, faites une déclaration séparée par date.",
    ...
    },
    {
      ...
      body: "Nouvelle adresse, IBAN, date d'effet : ayez ces éléments sous la main avant de commencer.",
      bodyKey: "changementSituation.journey.step3.body",
    },
    {
      order: 4,
      icon: "wallet",
      title: "Envoi à votre organisme de paiement",
      titleKey: "changementSituation.journey.step4.title",
      body: "Une fois complété, le C1 (et les formulaires complémentaires si besoin) part vers votre organisme de paiement (FGTB, CSC, SYNOVA, CAPAC).",
