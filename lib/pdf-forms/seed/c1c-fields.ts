...
export const C1C_FIELDS: PdfFormField[] = [
  ...
  // ==========================================================================
  {
    ...
    type: "textarea",
    required: true,
    label: { fr: "Description de l'activité accessoire exercée" },
    help: { fr: "Décris concrètement en quoi consiste ton activité indépendante." },
  ...
  },
  {
    ...
    type: "textarea",
    required: false,
    label: { fr: "Description de l'activité accessoire (suite)" },
    section: SECTION_ACTIVITES,
    order: 11,
  },
  {
  ...
  // seul des deux suffit, ou si l'ordre rue/commune est correct.
  {
    ...
    type: "text",
    required: false,
    label: { fr: "Autre adresse — rue et numéro" },
  ...
  },
  {
    ...
    type: "text",
    required: false,
    label: { fr: "Autre adresse — code postal et commune" },
    visibleIf: { fieldId: "lieuExerciceActivite", op: "equals", value: "autre" },
    section: SECTION_ACTIVITES,
    order: 17,
  },
  ...
  // ==========================================================================
  {
    ...
    options: [
      ...
      { value: "societe", label: { fr: "Société (mandataire, administrateur, gérant ou associé actif)" } },
    ],
    section: SECTION_ACTIVITES,
    order: 20,
  },
  ...
  // partagé, sinon il manque un champ BCE dans ce dump.
  {
    ...
    required: false,
    label: { fr: "Numéro BCE" },
    help: { fr: "Numéro d'entreprise (BCE) à 10 chiffres, si tu en disposes déjà." },
  ...
  // visuellement sur le PDF avant mise en production.
  {
    ...
    type: "text",
    required: false,
    label: { fr: "Autre (précise ta situation)" },
    help: {
  ...
  },
  {
    ...
    type: "radio",
    required: true,
    label: { fr: "Une partie de mon activité est exercée par des tiers (travailleurs, sous-traitants, apprentis)" },
    help: {
  ...
  // ==========================================================================
  {
    ...
    type: "number",
    required: true,
    label: { fr: "Revenu brut total annuel de l'activité (EUR/an)" },
    help: {
  ...
  },
  {
    ...
    type: "number",
    required: true,
    label: { fr: "Revenu net imposable annuel de l'indépendant (EUR/an)" },
    help: {
  ...
  },
  {
    ...
    type: "textarea",
    required: false,
    label: { fr: "Description de chaque activité antérieure exercée" },
  ...
  },
  {
    ...
    type: "textarea",
    required: false,
    label: { fr: "Description de chaque activité antérieure exercée (suite)" },
    visibleIf: { fieldId: "activiteIndependanteAnterieure", op: "equals", value: "oui" },
    section: SECTION_ACTIVITES_ANTERIEURES,
    order: 42,
  },
  ...
  // ==========================================================================
  {
    ...
    help: { fr: "Décris les documents que tu joins à cette déclaration, s'il y en a." },
  ...
  },
  {
    ...
    type: "textarea",
    required: false,
    label: { fr: "Je joins en annexe(s) (suite)" },
    section: SECTION_ANNEXES,
    order: 201,
  },
